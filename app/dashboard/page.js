            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 mt-10'>
                {fileList?.length>0?fileList?.map((file,index)=>(
                  <Link href={'/workspace/'+file.fileId}>
                   <div key={index} className='flex p-5 shadow-md rounded-md flex-col items-center justify border cursor-pointer hover:scale-105 transition-all'>
                    <Image src={'/pdficon.png'} alt='pdf' width={50} height={50}/>
